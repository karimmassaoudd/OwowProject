  ...
  return (
    <div className="w-full bg-background pt-4 pb-4">
      ...
      <div className="w-full mb-6">
        <div className="w-full bg-black border-2 border-neutral-800 rounded-lg overflow-hidden" style={{ aspectRatio: '2/1' }}>
          <div className="w-full h-full flex items-center justify-center">
            {hasStar ? (
              ...
              <div className="text-neutral-600 text-lg">Frame {selectedFrame + 1}</div>
            )}
          </div>
        </div>
      </div>
